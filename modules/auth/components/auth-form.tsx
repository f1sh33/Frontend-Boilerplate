...
import type { LoginRequest, RegisterRequest } from '@/modules/auth/api/types';
import { useLogin, useRegister } from '@/modules/auth/api/hooks';
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                <h1 className="text-2xl font-bold">
                                    {variant === 'login' ? 'Welcome back' : 'Welcome to our platform'}
                                </h1>
                                <p className="text-muted-foreground text-balance">
                                    {variant === 'login' ? 'Login to your account' : 'Create an account to get started'}
                                </p>
                            </div>
